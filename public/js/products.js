// EGO product catalog. Prices are in USD cents (Stripe convention).
const PRODUCTS = [
  {
    id: "ego-hoodie-black",
  ...
  },
  {
    ...
    description:
      "The everyday tee. 220gsm combed cotton, reinforced collar, subtle back-neck EGO tab.",
    sizes: ["S", "M", "L", "XL", "XXL"]
  },
  {
  ...
  },
  {
    ...
    description:
      "Water-resistant shell coach jacket with snap-button placket and embroidered back graphic.",
    sizes: ["S", "M", "L", "XL"]
  },
  {
    ...
    description:
      "Insulated puffer with matte finish shell, storm cuffs, and detachable hood. Built for cold.",
    sizes: ["S", "M", "L", "XL"]
  },
  {
    id: "ego-pants-cargo",
    ...
    description:
      "Straight-leg cargo pants in ripstop cotton with reinforced knees and six-pocket utility layout.",
  ...
  },
  {
    ...
    description:
      "Tapered track pants in brushed-back fleece with side stripe detailing and zip ankles.",
    sizes: ["S", "M", "L", "XL"]
  },
  {
    id: "ego-cap-logo",
    ...
    description:
      "Structured 6-panel cap with embroidered EGO logo and adjustable strap back.",
    sizes: ["One Size"]
  },
  {
    id: "ego-beanie",
    ...
    description:
      "Ribbed knit beanie in heavyweight acrylic with woven EGO label.",
    sizes: ["One Size"]
  },
  {
    id: "ego-tote",
    ...
    description:
      "Heavy canvas tote with reinforced handles and screen-printed EGO graphic.",
    sizes: ["One Size"]
  }
];
...
// Allow this catalog to also be required from the Node/Express server so
// checkout prices are always looked up server-side, never trusted from the client.
if (typeof module !== "undefined" && module.exports) {
  module.exports = { PRODUCTS, formatPrice, getProductById };
}
